...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> SIYONITE_BLOCKS_TAB = CREATIVE_MODE_TAB.register("siyonite_blocks_tab",
            () ->CreativeModeTab.builder()
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModBlocks.DEEPSLATE_SIYONITE_ORE);
                    }).build());
